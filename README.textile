...
For example I changed <Leader> to ',' and added some more key mappings which are located in key_mappings.vim. But I will probably reorganize the storage of the mappings soon.
...
<pre><code>
apt-get install exuberant-ctags ncurses-term ack-grep
</code></pre>
...
* "http://vimcasts.org":Vimcasts
* "http://vim.wikia.com/wiki/Vim_Tips_Wiki":VimTipsWiki
